"""
IITMDSA-B6 Assignment question:

Create a database and a table named Student in it. Using Python get values form user 
such as Name of the student,ID,Departmaent,Marks of 5 subjects. Calculate total,average and grade in Python 
